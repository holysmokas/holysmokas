import"./modulepreload-polyfill-B5Qt9EMX-ulV_1b7r.js";import"./authLogic-CC4CpbKG-CrBVcBcr.js";import{j as r,H as d}from"./firebase-BtvxRjGj-Bmveahn2.js";/* empty css                       */let a=null,i=null;r(d,async t=>{t?(a=t,await c(t.uid)):window.location.href="/src/frontend/pages/login.html"});async function c(t){try{const e=await(await fetch(`http://localhost:8080/user-projects/${t}`)).json(),n=document.getElementById("projectsContainer");e.success&&e.projects.length>0?n.innerHTML=e.projects.map(o=>`
