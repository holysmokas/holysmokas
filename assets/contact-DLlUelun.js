import"./modulepreload-polyfill-B5Qt9EMX.js";/* empty css              */import{E as h}from"./config-c1XWWVWh.js";function p(n,e,t=!0){const i=document.getElementById("formModal"),o=document.getElementById("modalTitle"),a=document.getElementById("modalMessage"),r=document.getElementById("modalIcon");o.textContent=n,a.textContent=e,r.textContent=t?"✓":"✕",r.style.background=t?"var(--secondary)":"#ef4444",i.classList.add("show")}window.closeModal=function(){document.getElementById("formModal").classList.remove("show")};function $(n){let e=n.replace(/^https?:\/\//,"");return e=e.replace(/^www\./,""),e=e.split("/")[0],e=e.trim(),e}window.checkDomain=async function(){const n=document.getElementById("domainInput"),e=document.getElementById("domainResult"),t=n.value.trim();if(!t){e.innerHTML="⚠️ Please enter a domain name.",e.style.color="#f59e0b";return}e.innerHTML="🔍 Checking availability...",e.style.color="#6b7280";try{const o=await(await fetch(h.checkDomain,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({domain:t})})).json();if(o.available===!0){const a=o.cleanedDomain||$(t),r=o.pricing?.initialCost||o.price||12.99,l=o.pricing?.renewalCost||o.renewalPrice||12.99;e.innerHTML=`
