import"./modulepreload-polyfill-B5Qt9EMX.js";/* empty css              */import{E as z}from"./config-Bhgf-sej.js";function u(t,e,n=!0){const o=document.getElementById("formModal"),s=document.getElementById("modalTitle"),a=document.getElementById("modalMessage"),i=document.getElementById("modalIcon");s.textContent=t,a.textContent=e,i.textContent=n?"✓":"✕",i.style.background=n?"var(--secondary)":"#ef4444",o.classList.add("show")}window.closeModal=function(){document.getElementById("formModal").classList.remove("show")};function R(t){let e=t.replace(/^https?:\/\//,"");return e=e.replace(/^www\./,""),e=e.split("/")[0],e=e.trim(),e}window.checkDomain=async function(){var o,s;const t=document.getElementById("domainInput"),e=document.getElementById("domainResult"),n=t.value.trim();if(!n){e.innerHTML="⚠️ Please enter a domain name.",e.style.color="#f59e0b";return}e.innerHTML="🔍 Checking availability...",e.style.color="#6b7280";try{const i=await(await fetch(z.checkDomain,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({domain:n})})).json();if(i.available===!0){const l=i.cleanedDomain||R(n),c=((o=i.pricing)==null?void 0:o.initialCost)||i.price||12.99,m=((s=i.pricing)==null?void 0:s.renewalCost)||i.renewalPrice||12.99;e.innerHTML=`
                <div style="background: #f0fdf4; border: 2px solid #10b981; border-radius: 8px; padding: 1rem; margin-top: 1rem;">
                    ...
                    <div style="background: white; padding: 0.75rem; border-radius: 6px; margin-bottom: 0.75rem;">
                        ...
                        <div style="display: flex; justify-content: space-between;">
                            ...
                            <strong style="color: #059669; font-size: 1.1rem;">$${m.toFixed(2)}/year</strong>
                        </div>
                    </div>
            ...
            `,e.style.color="#10b981",window.selectedDomain=l,window.domainPricing={initialCost:c,renewalCost:m}}else{const l=i.domain||n;e.innerHTML=`
    ...
    `,y()};function B(t){if(!t||t.includes("Select a package"))return null;const e={"Starter - $599 (New Website)":599,"Business - $1,199 (New Website)":1199,"Small Shop - $0.99 (New Website)":.99};for(const[n,o]of Object.entries(e))if(t.includes(n)||t.includes(o))return o;return 0}function q(t){if(!t)return"business";const e=t.toLowerCase();return e.includes("small shop")||e.includes("smallshop")?"smallshop":e.includes("starter")?"starter":e.includes("business")?"business":e.includes("enterprise")||e.includes("e-commerce")?"enterprise":"business"}function y(){const t=document.getElementById("package"),e=document.getElementById("pricingBreakdown");if(!t||!e)return;const n=t.value,o=B(n);if(o===null||n.includes("Select a package")){e.style.display="none";return}const s=window.domainPricing?window.domainPricing.initialCost:0,a=o+s;o>0?(e.innerHTML=`
        ...
        `,e.style.display="block"):e.style.display="none"}window.removeDomainFromForm=function(){const t=document.getElementById("currentUrl");t&&(t.value=""),window.selectedDomain=null,window.domainPricing=null;const e=document.getElementById("domainInput");e&&(e.value="");const n=document.getElementById("domainResult");n&&(n.innerHTML=""),y()};window.handleContactSubmit=async function(t){var w,v,x,h,k,P,D,I,E,S;t.preventDefault();const e=t.target,n=((w=e.querySelector("#name"))==null?void 0:w.value.trim())||"",o=((v=e.querySelector("#email"))==null?void 0:v.value.trim())||"",s=((x=e.querySelector("#businessName"))==null?void 0:x.value.trim())||"",a=((h=e.querySelector("#phone"))==null?void 0:h.value.trim())||"",i=((k=e.querySelector("#package"))==null?void 0:k.value.trim())||"",l=((P=e.querySelector("#timeline"))==null?void 0:P.value.trim())||"",c=((D=e.querySelector("#currentUrl"))==null?void 0:D.value.trim())||"",m=((I=e.querySelector("#referenceWebsite"))==null?void 0:I.value.trim())||"",F=((E=e.querySelector("#mainGoal"))==null?void 0:E.value.trim())||"",L=((S=e.querySelector("#mustHaveFeatures"))==null?void 0:S.value.trim())||"",f=e.querySelector("#logoUpload"),p=(f==null?void 0:f.files[0])||null,b=B(i);if(b===null||i.includes("Select a package")){u("Please Select a Package","Please choose a website package before submitting your request.",!1);return}const T=window.domainPricing?window.domainPricing.initialCost:0,C=b+T;if(p&&p.size>5*1024*1024){u("Logo Too Large","Please upload a logo smaller than 5MB.",!1);return}const d=document.getElementById("submitBtn");if(!d){console.error("Submit button not found!"),u("Error","Form submission error. Please refresh the page and try again.",!1);return}const M=d.textContent;d.textContent=p?"Uploading Logo...":"Creating Payment Session...",d.disabled=!0;try{const r=new FormData;r.append("name",n),r.append("email",o),r.append("businessName",s),r.append("phone",a),r.append("package",i),r.append("packagePrice",b),r.append("timeline",l),r.append("currentUrl",c),r.append("referenceWebsite",m),r.append("mainGoal",F),r.append("mustHaveFeatures",L),r.append("selectedDomain",window.selectedDomain||"N/A"),r.append("domainPricing",JSON.stringify(window.domainPricing)),r.append("totalCost",C),r.append("timestamp",new Date().toISOString()),r.append("status","pending_payment");const $=q(i);r.append("category",$),console.log("📦 Package category:",$,"from package:",i),p&&r.append("logo",p);const g=await(await fetch(z.createPaymentSession,{method:"POST",body:r})).json();if(g.success&&g.sessionUrl)u("🎉 Request Submitted Successfully!","Redirecting you to secure payment...",!0),setTimeout(()=>{window.location.href=g.sessionUrl},2e3);else throw new Error(g.error||"Failed to create payment session")}catch(r){console.error("Error creating payment session:",r),u("Error","There was an error processing your request. Please try again or contact us at (415) 691-7085.",!1),d.textContent=M,d.disabled=!1}};document.addEventListener("DOMContentLoaded",()=>{const t=document.getElementById("logoUpload"),e=document.getElementById("logoPreview"),n=document.getElementById("logoPreviewImage"),o=document.getElementById("removeLogo");t&&t.addEventListener("change",s=>{const a=s.target.files[0];if(a){if(a.size>5*1024*1024){alert("Logo file must be less than 5MB"),t.value="";return}const i=new FileReader;i.onload=l=>{n.src=l.target.result,e.style.display="block"},i.readAsDataURL(a)}else e.style.display="none"}),o&&o.addEventListener("click",()=>{t.value="",e.style.display="none",n.src=""})});document.addEventListener("DOMContentLoaded",()=>{const t=document.getElementById("package");t&&t.addEventListener("change",y),y()});
