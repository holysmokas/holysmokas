...
`;document.head.appendChild(B);document.addEventListener("DOMContentLoaded",()=>{console.log("🚀 DriveUI: Initialized"),L()});window.checkDriveStatus=k;
