...
* See the License for the specific language governing permissions and
* limitations under the License.
*/const rd=()=>sd().__FIREBASE_DEFAULTS__,id=()=>{if(typeof process>"u"||typeof Qa>"u")return;const n=Qa.__FIREBASE_DEFAULTS__;if(n)return JSON.parse(n)},od=()=>{if(typeof document>"u")return;let n;try{n=document.cookie.match(/__FIREBASE_DEFAULTS__=([^;]+)/)}catch{return}const e=n&&qh(n[1]);return e&&JSON.parse(e)},ca=()=>{try{return Zu()||rd()||id()||od()}catch(n){console.info(`Unable to get __FIREBASE_DEFAULTS__ due to: ${n}`);return}},Kh=n=>ca()?.emulatorHosts?.[n],Jh=n=>{const e=Kh(n);if(!e)return;const t=e.lastIndexOf(":");if(t<=0||t+1===e.length)throw new Error(`Invalid host ${e} with no separate hostname and port!`);const s=parseInt(e.substring(t+1),10);return e[0]==="["?[e.substring(1,t-1),s]:[e.substring(0,t),s]},Xh=()=>ca()?.config,Yh=n=>ca()?.[`_${n}`];/**
* @license
* Copyright 2017 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/function $s(n){try{return(n.startsWith("http://")||n.startsWith("https://")?new URL(n).hostname:n).endsWith(".cloudworkstations.dev")}catch{return!1}}async function ha(n){return(await fetch(n,{credentials:"include"})).ok}/**
* @license
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/var Z;(function(n){n[n.DEBUG=0]="DEBUG",n[n.VERBOSE=1]="VERBOSE",n[n.INFO=2]="INFO",n[n.WARN=3]="WARN",n[n.ERROR=4]="ERROR",n[n.SILENT=5]="SILENT"})(Z||(Z={}));const Cd={debug:Z.DEBUG,verbose:Z.VERBOSE,info:Z.INFO,warn:Z.WARN,error:Z.ERROR,silent:Z.SILENT},Rd=Z.INFO,Pd={[Z.DEBUG]:"log",[Z.VERBOSE]:"log",[Z.INFO]:"info",[Z.WARN]:"warn",[Z.ERROR]:"error"},Nd=(n,e,...t)=>{if(e<n.logLevel)return;const s=new Date().toISOString(),i=Pd[e];if(i)console[i](`[${s}]  ${n.name}:`,...t);else throw new Error(`Attempted to log a message with an invalid logType (value: ${e})`)};class ua{constructor(e){this.name=e,this._logLevel=Rd,this._logHandler=Nd,this._userLogHandler=null}get logLevel(){return this._logLevel}set logLevel(e){if(!(e in Z))throw new TypeError(`Invalid value "${e}" assigned to \`logLevel\``);this._logLevel=e}setLogLevel(e){this._logLevel=typeof e=="string"?Cd[e]:e}get logHandler(){return this._logHandler}set logHandler(e){if(typeof e!="function")throw new TypeError("Value assigned to `logHandler` must be a function");this._logHandler=e}get userLogHandler(){return this._userLogHandler}set userLogHandler(e){this._userLogHandler=e}debug(...e){this._userLogHandler&&this._userLogHandler(this,Z.DEBUG,...e),this._logHandler(this,Z.DEBUG,...e)}log(...e){this._userLogHandler&&this._userLogHandler(this,Z.VERBOSE,...e),this._logHandler(this,Z.VERBOSE,...e)}info(...e){this._userLogHandler&&this._userLogHandler(this,Z.INFO,...e),this._logHandler(this,Z.INFO,...e)}warn(...e){this._userLogHandler&&this._userLogHandler(this,Z.WARN,...e),this._logHandler(this,Z.WARN,...e)}error(...e){this._userLogHandler&&this._userLogHandler(this,Z.ERROR,...e),this._logHandler(this,Z.ERROR,...e)}}const Od=(n,e)=>e.some(t=>n instanceof t);let tc,nc;function Dd(){return tc||(tc=[IDBDatabase,IDBObjectStore,IDBIndex,IDBCursor,IDBTransaction])}function Ld(){return nc||(nc=[IDBCursor.prototype.advance,IDBCursor.prototype.continue,IDBCursor.prototype.continuePrimaryKey])}const Zh=new WeakMap,zo=new WeakMap,el=new WeakMap,Eo=new WeakMap,da=new WeakMap;function Md(n){const e=new Promise((t,s)=>{const i=()=>{n.removeEventListener("success",c),n.removeEventListener("error",h)},c=()=>{t(an(n.result)),i()},h=()=>{s(n.error),i()};n.addEventListener("success",c),n.addEventListener("error",h)});return e.then(t=>{t instanceof IDBCursor&&Zh.set(t,n)}).catch(()=>{}),da.set(e,n),e}function Ud(n){if(zo.has(n))return;const e=new Promise((t,s)=>{const i=()=>{n.removeEventListener("complete",c),n.removeEventListener("error",h),n.removeEventListener("abort",h)},c=()=>{t(),i()},h=()=>{s(n.error||new DOMException("AbortError","AbortError")),i()};n.addEventListener("complete",c),n.addEventListener("error",h),n.addEventListener("abort",h)});zo.set(n,e)}let Wo={get(n,e,t){if(n instanceof IDBTransaction){if(e==="done")return zo.get(n);if(e==="objectStoreNames")return n.objectStoreNames||el.get(n);if(e==="store")return t.objectStoreNames[1]?void 0:t.objectStore(t.objectStoreNames[0])}return an(n[e])},set(n,e,t){return n[e]=t,!0},has(n,e){return n instanceof IDBTransaction&&(e==="done"||e==="store")?!0:e in n}};function xd(n){Wo=n(Wo)}function Fd(n){return n===IDBDatabase.prototype.transaction&&!("objectStoreNames"in IDBTransaction.prototype)?function(e,...t){const s=n.call(So(this),e,...t);return el.set(s,e.sort?e.sort():[e]),an(s)}:Ld().includes(n)?function(...e){return n.apply(So(this),e),an(Zh.get(this))}:function(...e){return an(n.apply(So(this),e))}}function jd(n){return typeof n=="function"?Fd(n):(n instanceof IDBTransaction&&Ud(n),Od(n,Dd())?new Proxy(n,Wo):n)}function an(n){if(n instanceof IDBRequest)return Md(n);if(Eo.has(n))return Eo.get(n);const e=jd(n);return e!==n&&(Eo.set(n,e),da.set(e,n)),e}const So=n=>da.get(n);function Vd(n,e,{blocked:t,upgrade:s,blocking:i,terminated:c}={}){const h=indexedDB.open(n,e),I=an(h);return s&&h.addEventListener("upgradeneeded",T=>{s(an(h.result),T.oldVersion,T.newVersion,an(h.transaction),T)}),t&&h.addEventListener("blocked",T=>t(T.oldVersion,T.newVersion,T)),I.then(T=>{c&&T.addEventListener("close",()=>c()),i&&T.addEventListener("versionchange",E=>i(E.oldVersion,E.newVersion,E))}).catch(()=>{}),I}const Bd=["get","getKey","getAll","getAllKeys","count"],$d=["put","add","delete","clear"],Ao=new Map;function sc(n,e){if(!(n instanceof IDBDatabase&&!(e in n)&&typeof e=="string"))return;if(Ao.get(e))return Ao.get(e);const t=e.replace(/FromIndex$/,""),s=e!==t,i=$d.includes(t);if(!(t in(s?IDBIndex:IDBObjectStore).prototype)||!(i||Bd.includes(t)))return;const c=async function(h,...I){const T=this.transaction(h,i?"readwrite":"readonly");let E=T.store;return s&&(E=E.index(I.shift())),(await Promise.all([E[t](...I),i&&T.done]))[0]};return Ao.set(e,c),c}xd(n=>({...n,get:(e,t,s)=>sc(e,t)||n.get(e,t,s),has:(e,t)=>!!sc(e,t)||n.has(e,t)}));/**
* @license
* Copyright 2019 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/class Hd{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(e=>{if(zd(e)){const t=e.getImmediate();return`${t.library}/${t.version}`}else return null}).filter(e=>e).join(" ")}}function zd(n){return n.getComponent()?.type==="VERSION"}const Go="@firebase/app",rc="0.14.4";/**
* @license
* Copyright 2019 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/const Dt=new ua("@firebase/app"),Wd="@firebase/app-compat",Gd="@firebase/analytics-compat",qd="@firebase/analytics",Kd="@firebase/app-check-compat",Jd="@firebase/app-check",Xd="@firebase/auth",Yd="@firebase/auth-compat",Qd="@firebase/database",Zd="@firebase/data-connect",ef="@firebase/database-compat",tf="@firebase/functions",nf="@firebase/functions-compat",sf="@firebase/installations",rf="@firebase/installations-compat",of="@firebase/messaging",af="@firebase/messaging-compat",cf="@firebase/performance",hf="@firebase/performance-compat",lf="@firebase/remote-config",uf="@firebase/remote-config-compat",df="@firebase/storage",ff="@firebase/storage-compat",pf="@firebase/firestore",gf="@firebase/ai",mf="@firebase/firestore-compat",yf="firebase",_f="12.4.0";/**
* @license
* Copyright 2019 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/const qo="[DEFAULT]",wf={[Go]:"fire-core",[Wd]:"fire-core-compat",[qd]:"fire-analytics",[Gd]:"fire-analytics-compat",[Jd]:"fire-app-check",[Kd]:"fire-app-check-compat",[Xd]:"fire-auth",[Yd]:"fire-auth-compat",[Qd]:"fire-rtdb",[Zd]:"fire-data-connect",[ef]:"fire-rtdb-compat",[tf]:"fire-fn",[nf]:"fire-fn-compat",[sf]:"fire-iid",[rf]:"fire-iid-compat",[of]:"fire-fcm",[af]:"fire-fcm-compat",[cf]:"fire-perf",[hf]:"fire-perf-compat",[lf]:"fire-rc",[uf]:"fire-rc-compat",[df]:"fire-gcs",[ff]:"fire-gcs-compat",[pf]:"fire-fst",[mf]:"fire-fst-compat",[gf]:"fire-vertex","fire-js":"fire-js",[yf]:"fire-js-all"};/**
* @license
* Copyright 2019 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/const Li=new Map,vf=new Map,Ko=new Map;function ic(n,e){try{n.container.addComponent(e)}catch(t){Dt.debug(`Component ${e.name} failed to register with FirebaseApp ${n.name}`,t)}}function es(n){const e=n.name;if(Ko.has(e))return Dt.debug(`There were multiple attempts to register component ${e}.`),!1;Ko.set(e,n);for(const t of Li.values())ic(t,n);for(const t of vf.values())ic(t,n);return!0}function to(n,e){const t=n.container.getProvider("heartbeat").getImmediate({optional:!0});return t&&t.triggerHeartbeat(),n.container.getProvider(e)}function Le(n){return n==null?!1:n.settings!==void 0}/**
* @license
* Copyright 2019 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/const cs=_f;function tl(n,e={}){let t=n;typeof e!="object"&&(e={name:e});const s={name:qo,automaticDataCollectionEnabled:!0,...e},i=s.name;if(typeof i!="string"||!i)throw cn.create("bad-app-name",{appName:String(i)});if(t||(t=Xh()),!t)throw cn.create("no-options");const c=Li.get(i);if(c){if(Zn(t,c.options)&&Zn(s,c.config))return c;throw cn.create("duplicate-app",{appName:i})}const h=new kd(i);for(const T of Ko.values())h.addComponent(T);const I=new If(t,s,h);return Li.set(i,I),I}function fa(n=qo){const e=Li.get(n);if(!e&&n===qo&&Xh())return tl();if(!e)throw cn.create("no-app",{appName:n});return e}function nt(n,e,t){let s=wf[n]??n;t&&(s+=`-${t}`);const i=s.match(/\s|\//),c=e.match(/\s|\//);if(i||c){const h=[`Unable to register library "${s}" with version "${e}":`];i&&h.push(`library name "${s}" contains illegal characters (whitespace or "/")`),i&&c&&h.push("and"),c&&h.push(`version name "${e}" contains illegal characters (whitespace or "/")`),Dt.warn(h.join(" "));return}es(new un(`${s}-version`,()=>({library:s,version:e}),"VERSION"))}/**
* @license
* Copyright 2021 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/function Of(n){es(new un("platform-logger",e=>new Hd(e),"PRIVATE")),es(new un("heartbeat",e=>new Cf(e),"PRIVATE")),nt(Go,rc,n),nt(Go,rc,"esm2020"),nt("fire-js","")}Of("");var Df="firebase",Lf="12.4.0";/**
* @license
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/const Fs=new ua("@firebase/firestore");function Ue(n,...e){if(Fs.logLevel<=Z.DEBUG){const t=e.map(ga);Fs.debug(`Firestore (${Hr}): ${n}`,...t)}}function rl(n,...e){if(Fs.logLevel<=Z.ERROR){const t=e.map(ga);Fs.error(`Firestore (${Hr}): ${n}`,...t)}}function Mf(n,...e){if(Fs.logLevel<=Z.WARN){const t=e.map(ga);Fs.warn(`Firestore (${Hr}): ${n}`,...t)}}function ga(n){if(typeof n=="string")return n;try{/**
* @license
* Copyright 2020 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/class ts{constructor(e){this.binaryString=e}static fromBase64String(e){const t=(function(s){try{return atob(s)}catch(i){throw typeof DOMException<"u"&&i instanceof DOMException?new Zf("Invalid base64 string: "+i):i}})(e);return new ts(t)}static fromUint8Array(e){const t=(function(s){let i="";for(let c=0;c<s.length;++c)i+=String.fromCharCode(s[c]);return i})(e);return new ts(t)}[Symbol.iterator](){let e=0;return{next:()=>e<this.binaryString.length?{value:this.binaryString.charCodeAt(e++),done:!1}:{value:void 0,done:!0}}}toBase64(){return(function(e){return btoa(e)})(this.binaryString)}toUint8Array(){return(function(e){const t=new Uint8Array(e.length);for(let s=0;s<e.length;s++)t[s]=e.charCodeAt(s);return t})(this.binaryString)}approximateByteSize(){return 2*this.binaryString.length}compareTo(e){return dn(this.binaryString,e.binaryString)}isEqual(e){return this.binaryString===e.binaryString}}ts.EMPTY_BYTE_STRING=new ts("");const Jo="(default)";class Mi{constructor(e,t){this.projectId=e,this.database=t||Jo}static empty(){return new Mi("","")}get isDefaultDatabase(){return this.database===Jo}isEqual(e){return e instanceof Mi&&e.projectId===this.projectId&&e.database===this.database}}/**
* @license
* Copyright 2017 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/new pa([4294967295,4294967295],0);/**
* @license
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/class ya{constructor(e,t,s){this.converter=t,this._query=s,this.type="query",this.firestore=e}withConverter(e){return new ya(this.firestore,e,this._query)}}class et{constructor(e,t,s){this.converter=t,this._key=s,this.type="document",this.firestore=e}get _path(){return this._key.path}get id(){return this._key.path.lastSegment()}get path(){return this._key.path.canonicalString()}get parent(){return new _a(this.firestore,this.converter,this._key.path.popLast())}withConverter(e){return new et(this.firestore,e,this._key)}toJSON(){return{type:et._jsonSchemaVersion,referencePath:this._key.toString()}}static fromJSON(e,t,s){if(zr(t,et._jsonSchema))return new et(e,s||null,new Wn(Oe.fromString(t.referencePath)))}}et._jsonSchemaVersion="firestore/documentReference/1.0",et._jsonSchema={type:le("string",et._jsonSchemaVersion),referencePath:le("string")};class _a extends ya{constructor(e,t,s){super(e,t,tp(s)),this._path=s,this.type="collection"}get id(){return this._query.path.lastSegment()}get path(){return this._query.path.canonicalString()}get parent(){const e=this._path.popLast();return e.isEmpty()?null:new et(this.firestore,null,new Wn(e))}withConverter(e){return new _a(this.firestore,e,this._path)}}/**
* @license
* Copyright 2020 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/const Ic="AsyncQueue";class Tc{constructor(e=Promise.resolve()){this.Xu=[],this.ec=!1,this.tc=[],this.nc=null,this.rc=!1,this.sc=!1,this.oc=[],this.M_=new rp(this,"async_queue_retry"),this._c=()=>{const s=Ro();s&&Ue(Ic,"Visibility state changed to "+s.visibilityState),this.M_.w_()},this.ac=e;const t=Ro();t&&typeof t.addEventListener=="function"&&t.addEventListener("visibilitychange",this._c)}get isShuttingDown(){return this.ec}enqueueAndForget(e){this.enqueue(e)}enqueueAndForgetEvenWhileRestricted(e){this.uc(),this.cc(e)}enterRestrictedMode(e){if(!this.ec){this.ec=!0,this.sc=e||!1;const t=Ro();t&&typeof t.removeEventListener=="function"&&t.removeEventListener("visibilitychange",this._c)}}enqueue(e){if(this.uc(),this.ec)return new Promise((()=>{}));const t=new kr;return this.cc((()=>this.ec&&this.sc?Promise.resolve():(e().then(t.resolve,t.reject),t.promise))).then((()=>t.promise))}enqueueRetryable(e){this.enqueueAndForget((()=>(this.Xu.push(e),this.lc())))}async lc(){if(this.Xu.length!==0){try{await this.Xu[0](),this.Xu.shift(),this.M_.reset()}catch(e){if(!Qf(e))throw e;Ue(Ic,"Operation failed with retryable error: "+e)}this.Xu.length>0&&this.M_.p_((()=>this.lc()))}}cc(e){const t=this.ac.then((()=>(this.rc=!0,e().catch((s=>{throw this.nc=s,this.rc=!1,rl("INTERNAL UNHANDLED ERROR: ",Ec(s)),s})).then((s=>(this.rc=!1,s))))));return this.ac=t,t}enqueueAfterDelay(e,t,s){this.uc(),this.oc.indexOf(e)>-1&&(t=0);const i=ma.createAndSchedule(this,e,t,s,(c=>this.hc(c)));return this.tc.push(i),i}uc(){this.nc&&Ur(47125,{Pc:Ec(this.nc)})}verifyOperationInProgress(){}async Tc(){let e;do e=this.ac,await e;while(e!==this.ac)}Ic(e){for(const t of this.tc)if(t.timerId===e)return!0;return!1}Ec(e){return this.Tc().then((()=>{this.tc.sort(((t,s)=>t.targetTimeMs-s.targetTimeMs));for(const t of this.tc)if(t.skipDelay(),e!=="all"&&t.timerId===e)break;return this.Tc()}))}dc(e){this.oc.push(e)}hc(e){const t=this.tc.indexOf(e);this.tc.splice(t,1)}}function Ec(n){let e=n.message||"";return n.stack&&(e=n.stack.includes(n.message)?n.stack:n.message+`
`+n.stack),e}class ap extends cl{constructor(e,t,s,i){super(e,t,s,i),this.type="firestore",this._queue=new Tc,this._persistenceKey=i?.name||"[DEFAULT]"}async _terminate(){if(this._firestoreClient){const e=this._firestoreClient.terminate();this._queue=new Tc(e),this._firestoreClient=void 0,await e}}}function cp(n,e){const t=typeof n=="object"?n:fa(),s=typeof n=="string"?n:Jo,i=to(t,"firestore").getImmediate({identifier:s});if(!i._initialized){const c=Jh("firestore");c&&op(i,...c)}return i}/**
* @license
* Copyright 2020 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/const Ui=new ua("@firebase/auth");function pp(n,...e){Ui.logLevel<=Z.WARN&&Ui.warn(`Auth (${cs}): ${n}`,...e)}function Ei(n,...e){Ui.logLevel<=Z.ERROR&&Ui.error(`Auth (${cs}): ${n}`,...e)}/**
* @license
* Copyright 2020 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/function Lt(n,...e){throw wa(n,...e)}function st(n,...e){return wa(n,...e)}function pl(n,e,t){const s={...fp(),[e]:t};return new Br("auth","Firebase",s).create(e,{appName:n.name})}function Jn(n){return pl(n,"operation-not-supported-in-this-environment","Operations that alter the current user are not supported in conjunction with FirebaseServerApp")}function wa(n,...e){if(typeof n!="string"){const t=e[0],s=[...e.slice(1)];return s[0]&&(s[0].appName=n.name),n._errorFactory.create(t,...s)}return fl.create(n,...e)}function x(n,e,...t){if(!n)throw wa(e,...t)}function Rt(n){const e="INTERNAL ASSERTION FAILED: "+n;throw Ei(e),new Error(e)}function Mt(n,e){n||Rt(e)}/**
* @license
* Copyright 2020 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/function Xo(){return typeof self<"u"&&self.location?.href||""}function gp(){return Ac()==="http:"||Ac()==="https:"}function Ac(){return typeof self<"u"&&self.location?.protocol||null}/**
* @license
* Copyright 2020 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/function va(n,e){Mt(n.emulator,"Emulator should always be set here");const{url:t}=n.emulator;return e?`${t}${e.startsWith("/")?e.slice(1):e}`:t}/**
* @license
* Copyright 2020 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/async function Fi(n){const e=n.auth,t=await n.getIdToken(),s=await xr(n,xi(e,{idToken:t}));x(s?.users.length,e,"internal-error");const i=s.users[0];n._notifyReloadListener(i);const c=i.providerUserInfo?.length?_l(i.providerUserInfo):[],h=Cp(n.providerData,c),I=n.isAnonymous,T=!(n.email&&i.passwordHash)&&!h?.length,E=I?T:!1,C={uid:i.localId,displayName:i.displayName||null,photoURL:i.photoUrl||null,email:i.email||null,emailVerified:i.emailVerified||!1,phoneNumber:i.phoneNumber||null,tenantId:i.tenantId||null,providerData:h,metadata:new Yo(i.createdAt,i.lastLoginAt),isAnonymous:E};Object.assign(n,C)}async function kp(n){const e=as(n);await Fi(e),await e.auth._persistUserIfCurrent(e),e.auth._notifyListenersIfCurrent(e)}function Cp(n,e){return[...n.filter(t=>!e.some(s=>s.providerId===t.providerId)),...e]}function _l(n){return n.map(({providerId:e,...t})=>({providerId:e,uid:t.rawId||"",displayName:t.displayName||null,email:t.email||null,phoneNumber:t.phoneNumber||null,photoURL:t.photoUrl||null}))}/**
* @license
* Copyright 2020 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/function Pc(n){const e=n.toLowerCase();if(e.includes("opera/")||e.includes("opr/")||e.includes("opios/"))return"Opera";if(Tl(e))return"IEMobile";if(e.includes("msie")||e.includes("trident/"))return"IE";if(e.includes("edge/"))return"Edge";if(vl(e))return"Firefox";if(e.includes("silk/"))return"Silk";if(Sl(e))return"Blackberry";if(Al(e))return"Webos";if(bl(e))return"Safari";if((e.includes("chrome/")||Il(e))&&!e.includes("edge/"))return"Chrome";if(El(e))return"Android";{const t=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,s=n.match(t);if(s?.length===2)return s[1]}return"Other"}function vl(n=_e()){return/firefox\//i.test(n)}function bl(n=_e()){const e=n.toLowerCase();return e.includes("safari/")&&!e.includes("chrome/")&&!e.includes("crios/")&&!e.includes("android")}function Il(n=_e()){return/crios\//i.test(n)}function Tl(n=_e()){return/iemobile/i.test(n)}function El(n=_e()){return/android/i.test(n)}function Sl(n=_e()){return/blackberry/i.test(n)}function Al(n=_e()){return/webos/i.test(n)}function Ta(n=_e()){return/iphone|ipad|ipod/i.test(n)||/macintosh/i.test(n)&&/mobile/i.test(n)}function Np(n=_e()){return Ta(n)&&!!window.navigator?.standalone}function Op(){return pd()&&document.documentMode===10}function kl(n=_e()){return Ta(n)||El(n)||Al(n)||Sl(n)||/windows phone/i.test(n)||Tl(n)}/**
* @license
* Copyright 2020 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/async function Lp(n,e={}){return Hs(n,"GET","/v2/passwordPolicy",ba(n,e))}/**
* @license
* Copyright 2023 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/let Sa={async loadJS(){throw new Error("Unable to load external scripts")},recaptchaV2Script:"",recaptchaEnterpriseScript:"",gapiScript:""};function Fp(n){Sa=n}function jp(n){return Sa.loadJS(n)}function Vp(){return Sa.gapiScript}function Bp(n){return`__${n}${Math.floor(Math.random()*1e6)}`}/**
* @license
* Copyright 2020 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/function $p(n,e){const t=to(n,"auth");if(t.isInitialized()){const s=t.getImmediate(),i=t.getOptions();if(Zn(i,e??{}))return s;Lt(s,"already-initialized")}return t.initialize({options:e})}function Hp(n,e){const t=e?.persistence||[],s=(Array.isArray(t)?t:[t]).map(Pt);e?.errorMap&&n._updateErrorMap(e.errorMap),n._initializeWithPersistence(s,e?.popupRedirectResolver)}function zp(n,e,t){const s=Ea(n);x(/^https?:\/\//.test(e),s,"invalid-emulator-scheme");const i=!1,c=Rl(e),{host:h,port:I}=Wp(e),T=I===null?"":`:${I}`,E={url:`${c}//${h}${T}/`},C=Object.freeze({host:h,port:I,protocol:c.replace(":",""),options:Object.freeze({disableWarnings:i})});if(!s._canInitEmulator){x(s.config.emulator&&s.emulatorConfig,s,"emulator-config-failed"),x(Zn(E,s.config.emulator)&&Zn(C,s.emulatorConfig),s,"emulator-config-failed");return}s.config.emulator=E,s.emulatorConfig=C,s.settings.appVerificationDisabledForTesting=!0,$s(h)?(ha(`${c}//${h}${T}`),la("Auth",!0)):Gp()}function Rl(n){const e=n.indexOf(":");return e<0?"":n.substr(0,e+1)}function Wp(n){const e=Rl(n),t=/(\/\/)?([^?#/]+)/.exec(n.substr(e.length));if(!t)return{host:"",port:null};const s=t[2].split("@").pop()||"",i=/^(\[[^\]]+\])(:|$)/.exec(s);if(i){const c=i[1];return{host:c,port:Oc(s.substr(c.length+1))}}else{const[c,h]=s.split(":");return{host:c,port:Oc(h)}}}function Oc(n){if(!n)return null;const e=Number(n);return isNaN(e)?null:e}function Gp(){function n(){const e=document.createElement("p"),t=e.style;e.innerText="Running in emulator mode. Do not use with production credentials.",t.position="fixed",t.width="100%",t.backgroundColor="#ffffff",t.border=".1em solid #000000",t.color="#b50000",t.bottom="0px",t.left="0px",t.margin="0px",t.zIndex="10000",t.textAlign="center",e.classList.add("firebase-emulator-warning"),document.body.appendChild(e)}typeof console<"u"&&typeof console.info=="function"&&console.info("WARNING: You are using the Auth Emulator, which is intended for local testing only.  Do not use with production credentials."),typeof window<"u"&&typeof document<"u"&&(document.readyState==="loading"?window.addEventListener("DOMContentLoaded",n):n())}/**
* @license
* Copyright 2020 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/async function Ds(n,e){return bp(n,"POST","/v1/accounts:signInWithIdp",ba(n,e))}/**
* @license
* Copyright 2020 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/class ka extends Pl{constructor(e){super("custom","custom"),this.params=e}_getIdTokenResponse(e){return Ds(e,this._buildIdpRequest())}_linkToIdToken(e,t){return Ds(e,this._buildIdpRequest(t))}_getReauthenticationResolver(e){return Ds(e,this._buildIdpRequest())}_buildIdpRequest(e){const t={requestUri:this.params.requestUri,sessionId:this.params.sessionId,postBody:this.params.postBody,tenantId:this.params.tenantId,pendingToken:this.params.pendingToken,returnSecureToken:!0,returnIdpCredential:!0};return e&&(t.idToken=e),t}}function gg(n){return Xp(n.auth,new ka(n),n.bypassAuthState)}function mg(n){const{auth:e,user:t}=n;return x(t,e,"internal-error"),Jp(t,new ka(n),n.bypassAuthState)}async function yg(n){const{auth:e,user:t}=n;return x(t,e,"internal-error"),Kp(t,new ka(n),n.bypassAuthState)}/**
* @license
* Copyright 2020 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function zs(n){try{return(n.startsWith("http://")||n.startsWith("https://")?new URL(n).hostname:n).endsWith(".cloudworkstations.dev")}catch{return!1}}async function Na(n){return(await fetch(n,{credentials:"include"})).ok}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var ee;(function(n){n[n.DEBUG=0]="DEBUG",n[n.VERBOSE=1]="VERBOSE",n[n.INFO=2]="INFO",n[n.WARN=3]="WARN",n[n.ERROR=4]="ERROR",n[n.SILENT=5]="SILENT"})(ee||(ee={}));const wy={debug:ee.DEBUG,verbose:ee.VERBOSE,info:ee.INFO,warn:ee.WARN,error:ee.ERROR,silent:ee.SILENT},vy=ee.INFO,by={[ee.DEBUG]:"log",[ee.VERBOSE]:"log",[ee.INFO]:"info",[ee.WARN]:"warn",[ee.ERROR]:"error"},Iy=(n,e,...t)=>{if(e<n.logLevel)return;const s=new Date().toISOString(),i=by[e];if(i)console[i](`[${s}]  ${n.name}:`,...t);else throw new Error(`Attempted to log a message with an invalid logType (value: ${e})`)};class Da{constructor(e){this.name=e,this._logLevel=vy,this._logHandler=Iy,this._userLogHandler=null}get logLevel(){return this._logLevel}set logLevel(e){if(!(e in ee))throw new TypeError(`Invalid value "${e}" assigned to \`logLevel\``);this._logLevel=e}setLogLevel(e){this._logLevel=typeof e=="string"?wy[e]:e}get logHandler(){return this._logHandler}set logHandler(e){if(typeof e!="function")throw new TypeError("Value assigned to `logHandler` must be a function");this._logHandler=e}get userLogHandler(){return this._userLogHandler}set userLogHandler(e){this._userLogHandler=e}debug(...e){this._userLogHandler&&this._userLogHandler(this,ee.DEBUG,...e),this._logHandler(this,ee.DEBUG,...e)}log(...e){this._userLogHandler&&this._userLogHandler(this,ee.VERBOSE,...e),this._logHandler(this,ee.VERBOSE,...e)}info(...e){this._userLogHandler&&this._userLogHandler(this,ee.INFO,...e),this._logHandler(this,ee.INFO,...e)}warn(...e){this._userLogHandler&&this._userLogHandler(this,ee.WARN,...e),this._logHandler(this,ee.WARN,...e)}error(...e){this._userLogHandler&&this._userLogHandler(this,ee.ERROR,...e),this._logHandler(this,ee.ERROR,...e)}}const Ty=(n,e)=>e.some(t=>n instanceof t);let Qc,Zc;function Ey(){return Qc||(Qc=[IDBDatabase,IDBObjectStore,IDBIndex,IDBCursor,IDBTransaction])}function Sy(){return Zc||(Zc=[IDBCursor.prototype.advance,IDBCursor.prototype.continue,IDBCursor.prototype.continuePrimaryKey])}const tu=new WeakMap,Zo=new WeakMap,nu=new WeakMap,Lo=new WeakMap,La=new WeakMap;function Ay(n){const e=new Promise((t,s)=>{const i=()=>{n.removeEventListener("success",c),n.removeEventListener("error",h)},c=()=>{t(hn(n.result)),i()},h=()=>{s(n.error),i()};n.addEventListener("success",c),n.addEventListener("error",h)});return e.then(t=>{t instanceof IDBCursor&&tu.set(t,n)}).catch(()=>{}),La.set(e,n),e}function ky(n){if(Zo.has(n))return;const e=new Promise((t,s)=>{const i=()=>{n.removeEventListener("complete",c),n.removeEventListener("error",h),n.removeEventListener("abort",h)},c=()=>{t(),i()},h=()=>{s(n.error||new DOMException("AbortError","AbortError")),i()};n.addEventListener("complete",c),n.addEventListener("error",h),n.addEventListener("abort",h)});Zo.set(n,e)}let ea={get(n,e,t){if(n instanceof IDBTransaction){if(e==="done")return Zo.get(n);if(e==="objectStoreNames")return n.objectStoreNames||nu.get(n);if(e==="store")return t.objectStoreNames[1]?void 0:t.objectStore(t.objectStoreNames[0])}return hn(n[e])},set(n,e,t){return n[e]=t,!0},has(n,e){return n instanceof IDBTransaction&&(e==="done"||e==="store")?!0:e in n}};function Cy(n){ea=n(ea)}function Ry(n){return n===IDBDatabase.prototype.transaction&&!("objectStoreNames"in IDBTransaction.prototype)?function(e,...t){const s=n.call(Mo(this),e,...t);return nu.set(s,e.sort?e.sort():[e]),hn(s)}:Sy().includes(n)?function(...e){return n.apply(Mo(this),e),hn(tu.get(this))}:function(...e){return hn(n.apply(Mo(this),e))}}function Py(n){return typeof n=="function"?Ry(n):(n instanceof IDBTransaction&&ky(n),Ty(n,Ey())?new Proxy(n,ea):n)}function hn(n){if(n instanceof IDBRequest)return Ay(n);if(Lo.has(n))return Lo.get(n);const e=Py(n);return e!==n&&(Lo.set(n,e),La.set(e,n)),e}const Mo=n=>La.get(n);function Ny(n,e,{blocked:t,upgrade:s,blocking:i,terminated:c}={}){const h=indexedDB.open(n,e),I=hn(h);return s&&h.addEventListener("upgradeneeded",T=>{s(hn(h.result),T.oldVersion,T.newVersion,hn(h.transaction),T)}),t&&h.addEventListener("blocked",T=>t(T.oldVersion,T.newVersion,T)),I.then(T=>{c&&T.addEventListener("close",()=>c()),i&&T.addEventListener("versionchange",E=>i(E.oldVersion,E.newVersion,E))}).catch(()=>{}),I}const Oy=["get","getKey","getAll","getAllKeys","count"],Dy=["put","add","delete","clear"],Uo=new Map;function eh(n,e){if(!(n instanceof IDBDatabase&&!(e in n)&&typeof e=="string"))return;if(Uo.get(e))return Uo.get(e);const t=e.replace(/FromIndex$/,""),s=e!==t,i=Dy.includes(t);if(!(t in(s?IDBIndex:IDBObjectStore).prototype)||!(i||Oy.includes(t)))return;const c=async function(h,...I){const T=this.transaction(h,i?"readwrite":"readonly");let E=T.store;return s&&(E=E.index(I.shift())),(await Promise.all([E[t](...I),i&&T.done]))[0]};return Uo.set(e,c),c}Cy(n=>({...n,get:(e,t,s)=>eh(e,t)||n.get(e,t,s),has:(e,t)=>!!eh(e,t)||n.has(e,t)}));/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ly{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(t=>{if(My(t)){const s=t.getImmediate();return`${s.library}/${s.version}`}else return null}).filter(t=>t).join(" ")}}function My(n){return n.getComponent()?.type==="VERSION"}const ta="@firebase/app",th="0.14.4";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const na="[DEFAULT]",h_={[ta]:"fire-core",[Uy]:"fire-core-compat",[Fy]:"fire-analytics",[xy]:"fire-analytics-compat",[Vy]:"fire-app-check",[jy]:"fire-app-check-compat",[By]:"fire-auth",[$y]:"fire-auth-compat",[Hy]:"fire-rtdb",[zy]:"fire-data-connect",[Wy]:"fire-rtdb-compat",[Gy]:"fire-fn",[qy]:"fire-fn-compat",[Ky]:"fire-iid",[Jy]:"fire-iid-compat",[Xy]:"fire-fcm",[Yy]:"fire-fcm-compat",[Qy]:"fire-perf",[Zy]:"fire-perf-compat",[e_]:"fire-rc",[t_]:"fire-rc-compat",[n_]:"fire-gcs",[s_]:"fire-gcs-compat",[r_]:"fire-fst",[o_]:"fire-fst-compat",[i_]:"fire-vertex","fire-js":"fire-js",[a_]:"fire-js-all"};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Wi=new Map,l_=new Map,sa=new Map;function nh(n,e){try{n.container.addComponent(e)}catch(t){Ut.debug(`Component ${e.name} failed to register with FirebaseApp ${n.name}`,t)}}function rs(n){const e=n.name;if(sa.has(e))return Ut.debug(`There were multiple attempts to register component ${e}.`),!1;sa.set(e,n);for(const t of Wi.values())nh(t,n);for(const t of l_.values())nh(t,n);return!0}function ro(n,e){const t=n.container.getProvider("heartbeat").getImmediate({optional:!0});return t&&t.triggerHeartbeat(),n.container.getProvider(e)}function Me(n){return n==null?!1:n.settings!==void 0}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ls=c_;function su(n,e={}){let t=n;typeof e!="object"&&(e={name:e});const s={name:na,automaticDataCollectionEnabled:!0,...e},i=s.name;if(typeof i!="string"||!i)throw ln.create("bad-app-name",{appName:String(i)});if(t||(t=Ql()),!t)throw ln.create("no-options");const c=Wi.get(i);if(c){if(ss(t,c.options)&&ss(s,c.config))return c;throw ln.create("duplicate-app",{appName:i})}const h=new _y(i);for(const T of sa.values())h.addComponent(T);const I=new d_(t,s,h);return Wi.set(i,I),I}function Ma(n=na){const e=Wi.get(n);if(!e&&n===na&&Ql())return su();if(!e)throw ln.create("no-app",{appName:n});return e}function it(n,e,t){let s=h_[n]??n;t&&(s+=`-${t}`);const i=s.match(/\s|\//),c=e.match(/\s|\//);if(i||c){const h=[`Unable to register library "${s}" with version "${e}":`];i&&h.push(`library name "${s}" contains illegal characters (whitespace or "/")`),i&&c&&h.push("and"),c&&h.push(`version name "${e}" contains illegal characters (whitespace or "/")`),Ut.warn(h.join(" "));return}rs(new fn(`${s}-version`,()=>({library:s,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function I_(n){rs(new fn("platform-logger",e=>new Ly(e),"PRIVATE")),rs(new fn("heartbeat",e=>new __(e),"PRIVATE")),it(ta,th,n),it(ta,th,"esm2020"),it("fire-js","")}I_("");var T_="firebase",E_="12.4.0";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Vs=new Da("@firebase/firestore");function je(n,...e){if(Vs.logLevel<=ee.DEBUG){const t=e.map(xa);Vs.debug(`Firestore (${Xr}): ${n}`,...t)}}function ou(n,...e){if(Vs.logLevel<=ee.ERROR){const t=e.map(xa);Vs.error(`Firestore (${Xr}): ${n}`,...t)}}function S_(n,...e){if(Vs.logLevel<=ee.WARN){const t=e.map(xa);Vs.warn(`Firestore (${Xr}): ${n}`,...t)}}function xa(n){if(typeof n=="string")return n;try{/**
* @license
* Copyright 2020 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class is{constructor(e){this.binaryString=e}static fromBase64String(e){const t=(function(i){try{return atob(i)}catch(c){throw typeof DOMException<"u"&&c instanceof DOMException?new H_("Invalid base64 string: "+c):c}})(e);return new is(t)}static fromUint8Array(e){const t=(function(i){let c="";for(let h=0;h<i.length;++h)c+=String.fromCharCode(i[h]);return c})(e);return new is(t)}[Symbol.iterator](){let e=0;return{next:()=>e<this.binaryString.length?{value:this.binaryString.charCodeAt(e++),done:!1}:{value:void 0,done:!0}}}toBase64(){return(function(t){return btoa(t)})(this.binaryString)}toUint8Array(){return(function(t){const s=new Uint8Array(t.length);for(let i=0;i<t.length;i++)s[i]=t.charCodeAt(i);return s})(this.binaryString)}approximateByteSize(){return 2*this.binaryString.length}compareTo(e){return pn(this.binaryString,e.binaryString)}isEqual(e){return this.binaryString===e.binaryString}}is.EMPTY_BYTE_STRING=new is("");const ra="(default)";class Gi{constructor(e,t){this.projectId=e,this.database=t||ra}static empty(){return new Gi("","")}get isDefaultDatabase(){return this.database===ra}isEqual(e){return e instanceof Gi&&e.projectId===this.projectId&&e.database===this.database}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ja{constructor(e,t,s){this.converter=t,this._query=s,this.type="query",this.firestore=e}withConverter(e){return new ja(this.firestore,e,this._query)}}class tt{constructor(e,t,s){this.converter=t,this._key=s,this.type="document",this.firestore=e}get _path(){return this._key.path}get id(){return this._key.path.lastSegment()}get path(){return this._key.path.canonicalString()}get parent(){return new Va(this.firestore,this.converter,this._key.path.popLast())}withConverter(e){return new tt(this.firestore,e,this._key)}toJSON(){return{type:tt._jsonSchemaVersion,referencePath:this._key.toString()}}static fromJSON(e,t,s){if(Yr(t,tt._jsonSchema))return new tt(e,s||null,new Gn(De.fromString(t.referencePath)))}}tt._jsonSchemaVersion="firestore/documentReference/1.0",tt._jsonSchema={type:ue("string",tt._jsonSchemaVersion),referencePath:ue("string")};class Va extends ja{constructor(e,t,s){super(e,t,W_(s)),this._path=s,this.type="collection"}get id(){return this._query.path.lastSegment()}get path(){return this._query.path.canonicalString()}get parent(){const e=this._path.popLast();return e.isEmpty()?null:new tt(this.firestore,null,new Gn(e))}withConverter(e){return new Va(this.firestore,e,this._path)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const wh="AsyncQueue";class vh{constructor(e=Promise.resolve()){this.Xu=[],this.ec=!1,this.tc=[],this.nc=null,this.rc=!1,this.sc=!1,this.oc=[],this.M_=new K_(this,"async_queue_retry"),this._c=()=>{const s=jo();s&&je(wh,"Visibility state changed to "+s.visibilityState),this.M_.w_()},this.ac=e;const t=jo();t&&typeof t.addEventListener=="function"&&t.addEventListener("visibilitychange",this._c)}get isShuttingDown(){return this.ec}enqueueAndForget(e){this.enqueue(e)}enqueueAndForgetEvenWhileRestricted(e){this.uc(),this.cc(e)}enterRestrictedMode(e){if(!this.ec){this.ec=!0,this.sc=e||!1;const t=jo();t&&typeof t.removeEventListener=="function"&&t.removeEventListener("visibilitychange",this._c)}}enqueue(e){if(this.uc(),this.ec)return new Promise((()=>{}));const t=new Or;return this.cc((()=>this.ec&&this.sc?Promise.resolve():(e().then(t.resolve,t.reject),t.promise))).then((()=>t.promise))}enqueueRetryable(e){this.enqueueAndForget((()=>(this.Xu.push(e),this.lc())))}async lc(){if(this.Xu.length!==0){try{await this.Xu[0](),this.Xu.shift(),this.M_.reset()}catch(e){if(!$_(e))throw e;je(wh,"Operation failed with retryable error: "+e)}this.Xu.length>0&&this.M_.p_((()=>this.lc()))}}cc(e){const t=this.ac.then((()=>(this.rc=!0,e().catch((s=>{throw this.nc=s,this.rc=!1,ou("INTERNAL UNHANDLED ERROR: ",bh(s)),s})).then((s=>(this.rc=!1,s))))));return this.ac=t,t}enqueueAfterDelay(e,t,s){this.uc(),this.oc.indexOf(e)>-1&&(t=0);const i=Fa.createAndSchedule(this,e,t,s,(c=>this.hc(c)));return this.tc.push(i),i}uc(){this.nc&&jr(47125,{Pc:bh(this.nc)})}verifyOperationInProgress(){}async Tc(){let e;do e=this.ac,await e;while(e!==this.ac)}Ic(e){for(const t of this.tc)if(t.timerId===e)return!0;return!1}Ec(e){return this.Tc().then((()=>{this.tc.sort(((t,s)=>t.targetTimeMs-s.targetTimeMs));for(const t of this.tc)if(t.skipDelay(),e!=="all"&&t.timerId===e)break;return this.Tc()}))}dc(e){this.oc.push(e)}hc(e){const t=this.tc.indexOf(e);this.tc.splice(t,1)}}function bh(n){let e=n.message||"";return n.stack&&(e=n.stack.includes(n.message)?n.stack:n.message+`
`+n.stack),e}class Y_ extends lu{constructor(e,t,s,i){super(e,t,s,i),this.type="firestore",this._queue=new vh,this._persistenceKey=i?.name||"[DEFAULT]"}async _terminate(){if(this._firestoreClient){const e=this._firestoreClient.terminate();this._queue=new vh(e),this._firestoreClient=void 0,await e}}}function Q_(n,e){const t=typeof n=="object"?n:Ma(),s=typeof n=="string"?n:ra,i=ro(t,"firestore").getImmediate({identifier:s});if(!i._initialized){const c=Yl("firestore");c&&X_(i,...c)}return i}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const qi=new Da("@firebase/auth");function rw(n,...e){qi.logLevel<=ee.WARN&&qi.warn(`Auth (${ls}): ${n}`,...e)}function Ri(n,...e){qi.logLevel<=ee.ERROR&&qi.error(`Auth (${ls}): ${n}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function xt(n,...e){throw Ba(n,...e)}function ot(n,...e){return Ba(n,...e)}function mu(n,e,t){const s={...sw(),[e]:t};return new Kr("auth","Firebase",s).create(e,{appName:n.name})}function Qn(n){return mu(n,"operation-not-supported-in-this-environment","Operations that alter the current user are not supported in conjunction with FirebaseServerApp")}function Ba(n,...e){if(typeof n!="string"){const t=e[0],s=[...e.slice(1)];return s[0]&&(s[0].appName=n.name),n._errorFactory.create(t,...s)}return gu.create(n,...e)}function F(n,e,...t){if(!n)throw Ba(e,...t)}function Nt(n){const e="INTERNAL ASSERTION FAILED: "+n;throw Ri(e),new Error(e)}function Ft(n,e){n||Nt(e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ia(){return typeof self<"u"&&self.location?.href||""}function iw(){return Th()==="http:"||Th()==="https:"}function Th(){return typeof self<"u"&&self.location?.protocol||null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function $a(n,e){Ft(n.emulator,"Emulator should always be set here");const{url:t}=n.emulator;return e?`${t}${e.startsWith("/")?e.slice(1):e}`:t}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Lr(n){if(n)try{const e=new Date(Number(n));if(!isNaN(e.getTime()))return e.toUTCString()}catch{}}async function pw(n,e=!1){const t=hs(n),s=await t.getIdToken(e),i=za(s);F(i&&i.exp&&i.auth_time&&i.iat,t.auth,"internal-error");const c=typeof i.firebase=="object"?i.firebase:void 0,h=c?.sign_in_provider;return{claims:i,token:s,authTime:Lr(Vo(i.auth_time)),issuedAtTime:Lr(Vo(i.iat)),expirationTime:Lr(Vo(i.exp)),signInProvider:h||null,signInSecondFactor:c?.sign_in_second_factor||null}}function Vo(n){return Number(n)*1e3}function za(n){const[e,t,s]=n.split(".");if(e===void 0||t===void 0||s===void 0)return Ri("JWT malformed, contained fewer than 3 sections"),null;try{const i=Jl(t);return i?JSON.parse(i):(Ri("Failed to decode base64 JWT payload"),null)}catch(i){return Ri("Caught error parsing JWT payload as JSON",i?.toString()),null}}function Eh(n){const e=za(n);return F(e,"internal-error"),F(typeof e.exp<"u","internal-error"),F(typeof e.iat<"u","internal-error"),Number(e.exp)-Number(e.iat)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Ji(n){const e=n.auth,t=await n.getIdToken(),s=await Vr(n,Ki(e,{idToken:t}));F(s?.users.length,e,"internal-error");const i=s.users[0];n._notifyReloadListener(i);const c=i.providerUserInfo?.length?vu(i.providerUserInfo):[],h=_w(n.providerData,c),I=n.isAnonymous,T=!(n.email&&i.passwordHash)&&!h?.length,E=I?T:!1,C={uid:i.localId,displayName:i.displayName||null,photoURL:i.photoUrl||null,email:i.email||null,emailVerified:i.emailVerified||!1,phoneNumber:i.phoneNumber||null,tenantId:i.tenantId||null,providerData:h,metadata:new oa(i.createdAt,i.lastLoginAt),isAnonymous:E};Object.assign(n,C)}async function yw(n){const e=hs(n);await Ji(e),await e.auth._persistUserIfCurrent(e),e.auth._notifyListenersIfCurrent(e)}function _w(n,e){return[...n.filter(s=>!e.some(i=>i.providerId===s.providerId)),...e]}function vu(n){return n.map(({providerId:e,...t})=>({providerId:e,uid:t.rawId||"",displayName:t.displayName||null,email:t.email||null,phoneNumber:t.phoneNumber||null,photoURL:t.photoUrl||null}))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function kh(n){const e=n.toLowerCase();if(e.includes("opera/")||e.includes("opr/")||e.includes("opios/"))return"Opera";if(Su(e))return"IEMobile";if(e.includes("msie")||e.includes("trident/"))return"IE";if(e.includes("edge/"))return"Edge";if(Iu(e))return"Firefox";if(e.includes("silk/"))return"Silk";if(ku(e))return"Blackberry";if(Cu(e))return"Webos";if(Tu(e))return"Safari";if((e.includes("chrome/")||Eu(e))&&!e.includes("edge/"))return"Chrome";if(Au(e))return"Android";{const t=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,s=n.match(t);if(s?.length===2)return s[1]}return"Other"}function Iu(n=we()){return/firefox\//i.test(n)}function Tu(n=we()){const e=n.toLowerCase();return e.includes("safari/")&&!e.includes("chrome/")&&!e.includes("crios/")&&!e.includes("android")}function Eu(n=we()){return/crios\//i.test(n)}function Su(n=we()){return/iemobile/i.test(n)}function Au(n=we()){return/android/i.test(n)}function ku(n=we()){return/blackberry/i.test(n)}function Cu(n=we()){return/webos/i.test(n)}function Wa(n=we()){return/iphone|ipad|ipod/i.test(n)||/macintosh/i.test(n)&&/mobile/i.test(n)}function bw(n=we()){return Wa(n)&&!!window.navigator?.standalone}function Iw(){return iy()&&document.documentMode===10}function Ru(n=we()){return Wa(n)||Au(n)||Cu(n)||ku(n)||/windows phone/i.test(n)||Su(n)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Ew(n,e={}){return Ws(n,"GET","/v2/passwordPolicy",Ha(n,e))}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let qa={async loadJS(){throw new Error("Unable to load external scripts")},recaptchaV2Script:"",recaptchaEnterpriseScript:"",gapiScript:""};function Cw(n){qa=n}function Rw(n){return qa.loadJS(n)}function Pw(){return qa.gapiScript}function Nw(n){return`__${n}${Math.floor(Math.random()*1e6)}`}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ow(n,e){const t=ro(n,"auth");if(t.isInitialized()){const i=t.getImmediate(),c=t.getOptions();if(ss(c,e??{}))return i;xt(i,"already-initialized")}return t.initialize({options:e})}function Dw(n,e){const t=e?.persistence||[],s=(Array.isArray(t)?t:[t]).map(Ot);e?.errorMap&&n._updateErrorMap(e.errorMap),n._initializeWithPersistence(s,e?.popupRedirectResolver)}function Lw(n,e,t){const s=Ga(n);F(/^https?:\/\//.test(e),s,"invalid-emulator-scheme");const i=!1,c=Nu(e),{host:h,port:I}=Mw(e),T=I===null?"":`:${I}`,E={url:`${c}//${h}${T}/`},C=Object.freeze({host:h,port:I,protocol:c.replace(":",""),options:Object.freeze({disableWarnings:i})});if(!s._canInitEmulator){F(s.config.emulator&&s.emulatorConfig,s,"emulator-config-failed"),F(ss(E,s.config.emulator)&&ss(C,s.emulatorConfig),s,"emulator-config-failed");return}s.config.emulator=E,s.emulatorConfig=C,s.settings.appVerificationDisabledForTesting=!0,zs(h)?(Na(`${c}//${h}${T}`),Oa("Auth",!0)):Uw()}function Nu(n){const e=n.indexOf(":");return e<0?"":n.substr(0,e+1)}function Mw(n){const e=Nu(n),t=/(\/\/)?([^?#/]+)/.exec(n.substr(e.length));if(!t)return{host:"",port:null};const s=t[2].split("@").pop()||"",i=/^(\[[^\]]+\])(:|$)/.exec(s);if(i){const c=i[1];return{host:c,port:Rh(s.substr(c.length+1))}}else{const[c,h]=s.split(":");return{host:c,port:Rh(h)}}}function Rh(n){if(!n)return null;const e=Number(n);return isNaN(e)?null:e}function Uw(){function n(){const e=document.createElement("p"),t=e.style;e.innerText="Running in emulator mode. Do not use with production credentials.",t.position="fixed",t.width="100%",t.backgroundColor="#ffffff",t.border=".1em solid #000000",t.color="#b50000",t.bottom="0px",t.left="0px",t.margin="0px",t.zIndex="10000",t.textAlign="center",e.classList.add("firebase-emulator-warning"),document.body.appendChild(e)}typeof console<"u"&&typeof console.info=="function"&&console.info("WARNING: You are using the Auth Emulator, which is intended for local testing only.  Do not use with production credentials."),typeof window<"u"&&typeof document<"u"&&(document.readyState==="loading"?window.addEventListener("DOMContentLoaded",n):n())}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function xs(n,e){return uw(n,"POST","/v1/accounts:signInWithIdp",Ha(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ja extends Ou{constructor(e){super("custom","custom"),this.params=e}_getIdTokenResponse(e){return xs(e,this._buildIdpRequest())}_linkToIdToken(e,t){return xs(e,this._buildIdpRequest(t))}_getReauthenticationResolver(e){return xs(e,this._buildIdpRequest())}_buildIdpRequest(e){const t={requestUri:this.params.requestUri,sessionId:this.params.sessionId,postBody:this.params.postBody,tenantId:this.params.tenantId,pendingToken:this.params.pendingToken,returnSecureToken:!0,returnIdpCredential:!0};return e&&(t.idToken=e),t}}function iv(n){return Vw(n.auth,new Ja(n),n.bypassAuthState)}function ov(n){const{auth:e,user:t}=n;return F(t,e,"internal-error"),jw(t,new Ja(n),n.bypassAuthState)}async function av(n){const{auth:e,user:t}=n;return F(t,e,"internal-error"),Fw(t,new Ja(n),n.bypassAuthState)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */const qu="storage";function Ab(n=Ma(),e){n=hs(n);const s=ro(n,qu).getImmediate({identifier:e}),i=Yl("storage");return i&&kb(s,...i),s}function kb(n,e,t,s={}){Eb(n,e,t,s)}function Cb(n,{instanceIdentifier:e}){const t=n.getProvider("app").getImmediate(),s=n.getProvider("auth-internal"),i=n.getProvider("app-check-internal");return new Sb(t,s,i,e,ls)}function Rb(){rs(new fn(qu,Cb,"PUBLIC").setMultipleInstances(!0)),it(Hh,zh,""),it(Hh,zh,"esm2020")}Rb();const Pb={apiKey:"AIzaSyC0qVQm59S1_OFJcYLr2ILyGB9m-SoxHro",authDomain:"holysmokas-4ef36.firebaseapp.com",projectId:"holysmokas-4ef36",storageBucket:"holysmokas-4ef36.firebasestorage.app",messagingSenderId:"236391401471",appId:"1:236391401471:web:16780dc40257205caf09ca",measurementId:"G-LRKVZGKNLD"},Xa=su(Pb);Q_(Xa);Zv(Xa);Ab(Xa);const Ku="production",Ju={development:{API_BASE_URL:"http://localhost:3001",GOOGLE_SHEETS_URL:"https://script.google.com/macros/s/AKfycbzJOYtbHJRuIgQTT7BVhmzGvRaJ1TMBd-VDoe_DUk_Rbnyr9EBiB5W9Xutir8r8LcgUTg/exec",SITE_URL:"http://localhost:5173"},production:{API_BASE_URL:"https://api.holysmokas.com",GOOGLE_SHEETS_URL:"https://script.google.com/macros/s/AKfycbzJOYtbHJRuIgQTT7BVhmzGvRaJ1TMBd-VDoe_DUk_Rbnyr9EBiB5W9Xutir8r8LcgUTg/exec",SITE_URL:"https://holysmokas.com"}},Vn=Ju[Ku].API_BASE_URL,Xu=Ju[Ku].GOOGLE_SHEETS_URL,Yu={createPaymentSession:`${Vn}/create-payment-session`,stripeWebhook:`${Vn}/stripe-webhook`,userProjects:n=>`${Vn}/user-projects/${n}`,claimProjects:`${Vn}/claim-projects`,requestModification:`${Vn}/request-modification`,checkDomain:`${Vn}/check-domain`,deploy:`${Vn}/deploy`,contactFormSubmission:Xu};function Ho(n,e,t=!0){const s=document.getElementById("formModal"),i=document.getElementById("modalTitle"),c=document.getElementById("modalMessage"),h=document.getElementById("modalIcon");i.textContent=n,c.textContent=e,h.textContent=t?"✔":"✕",h.style.background=t?"var(--secondary)":"#ef4444",s.classList.add("show")}window.closeModal=function(){document.getElementById("formModal").classList.remove("show")};async function Nb(n){try{const e=await fetch(Xu,{method:"POST",mode:"no-cors",headers:{"Content-Type":"application/json"},body:JSON.stringify(n)});return console.log("Data sent to Google Apps Script"),!0}catch(e){return console.error("Error sending to Google Script:",e),!1}}function Ob(n){let e=n.replace(/^https?:\/\//,"");return e=e.replace(/^www\./,""),e=e.split("/")[0],e=e.trim(),e}window.checkDomain=async function(){const n=document.getElementById("domainInput"),e=document.getElementById("domainResult"),t=n.value.trim();if(!t){e.innerHTML="⚠️ Please enter a domain name.",e.style.color="#f59e0b";return}e.innerHTML="🔍 Checking availability...",e.style.color="#6b7280";try{const i=await(await fetch(Yu.checkDomain,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({domain:t})})).json();if(i.available===!0){const c=i.cleanedDomain||Ob(t),h=i.pricing?.initialCost||i.price||12.99,I=i.pricing?.renewalCost||i.renewalPrice||12.99;e.innerHTML=`
    ...
    `,i.style.color="#10b981",Ya()};function Qu(n){return n.includes("$499")?499:n.includes("$999")?999:n.includes("$1,999")?1999:(n.includes("Custom Quote"),0)}function Ya(){const n=document.getElementById("package"),e=document.getElementById("pricingBreakdown");if(!n||!e)return;const t=n.value,s=Qu(t),i=window.domainPricing?window.domainPricing.initialCost:0,c=s+i;s>0?(e.innerHTML=`
            <h3 style="color: #6366f1; font-size: 1.3rem; margin-bottom: 1rem; text-align: center;">
                💰 Price Breakdown
            </h3>
        ...
        `,e.style.display="block"):e.style.display="none"}window.removeDomainFromForm=function(){const n=document.getElementById("currentUrl");n&&(n.value=""),window.selectedDomain=null,window.domainPricing=null;const e=document.getElementById("domainInput");e&&(e.value="");const t=document.getElementById("domainResult");t&&(t.innerHTML=""),Ya()};window.handleContactSubmit=async function(n){n.preventDefault();const e=n.target,t=e.querySelector("#name")?.value.trim()||"",s=e.querySelector("#email")?.value.trim()||"",i=e.querySelector("#businessName")?.value.trim()||"",c=e.querySelector("#phone")?.value.trim()||"",h=e.querySelector("#package")?.value.trim()||"",I=e.querySelector("#timeline")?.value.trim()||"",T=e.querySelector("#currentUrl")?.value.trim()||"",E=e.querySelector("#referenceWebsite")?.value.trim()||"",C=e.querySelector("#mainGoal")?.value.trim()||"",k=e.querySelector("#mustHaveFeatures")?.value.trim()||"",R=Qu(h),L=window.domainPricing?window.domainPricing.initialCost:0,O=R+L;if(R===0){Ho("Please Select a Package","Please select a website package (Starter, Business, or Small Shop) before submitting.",!1);return}const D={name:t,email:s,businessName:i,phone:c,package:h,packagePrice:R,timeline:I,currentUrl:T,referenceWebsite:E,mainGoal:C,mustHaveFeatures:k,selectedDomain:window.selectedDomain||"N/A",domainPricing:window.domainPricing?{initialCost:window.domainPricing.initialCost,renewalCost:window.domainPricing.renewalCost}:null,totalCost:O,timestamp:new Date().toISOString(),status:"pending_payment"},N=document.getElementById("submitBtn");if(!N){console.error("Submit button not found!"),Ho("Error","Form submission error. Please refresh the page and try again.",!1);return}const V=N.textContent;N.textContent="Creating Payment Session...",N.disabled=!0;try{const U=await(await fetch(Yu.createPaymentSession,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(D)})).json();if(U.success&&U.sessionUrl)Nb(D).catch(H=>{console.warn("⚠️ Google Script submission failed, but proceeding to payment:",H)}),window.location.href=U.sessionUrl;else throw new Error(U.error||"Failed to create payment session")}catch(j){console.error("Error creating payment session:",j),Ho("Error","There was an error processing your request. Please try again or contact us at (415) 691-7085.",!1),N.textContent=V,N.disabled=!1}};document.addEventListener("DOMContentLoaded",()=>{const n=document.getElementById("package");n&&n.addEventListener("change",Ya)});
