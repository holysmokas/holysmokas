      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-2">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-xl font-bold">Making People Happy</span>
            </div>
            <p className="text-gray-400 mb-4 max-w-md">
              Dedicated to bringing joy and satisfaction to every interaction. We create memorable experiences that make a positive difference in your life.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              <li>hello@makingpeoplehappy.com</li>
              <li>(555) 123-HAPPY</li>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center">
          ...
          <p className="text-gray-400">
            &copy; 2025 Making People Happy. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
